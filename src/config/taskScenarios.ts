...
export const TASK_SCENARIOS: TaskScenario[] = [
  {
    ...
    directions: [
      { zh: "打个招呼，点你想喝的", en: "Hi, can I get a...?" },
      { zh: "问店员今天推荐什么", en: "What do you recommend today?" },
      { zh: "先要一份菜单看看", en: "Could I see the menu first?" },
      { zh: "问有没有无咖啡因的", en: "Do you have anything decaf?" },
      { zh: "问今天有没有特价", en: "Do you have any specials today?" },
      { zh: "犹豫一下，让店员帮你选", en: "I can't decide. What would you suggest?" },
    ],
    roleSetup:
  ...
  },
  {
    ...
    directions: [
      ...
      { zh: "说说你为什么想做这个岗位", en: "I'm interested in this role because..." },
      { zh: "简单聊聊你现在的工作", en: "In my current role, I mainly..." },
      { zh: "表达一下面试的心情", en: "I'm excited to be here because..." },
      { zh: "用一句话概括你自己", en: "In one sentence, I'm someone who..." },
    ],
    roleSetup:
