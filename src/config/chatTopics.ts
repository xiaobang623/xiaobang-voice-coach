...
export const FREE_TALK_DIRECTIONS: TalkDirection[] = [
  { zh: "今天发生的一件小事", en: "Something small that happened today was..." },
  { zh: "最近让你开心的事", en: "Something that made me happy lately was..." },
  { zh: "最近有点烦的事", en: "Something that's been bothering me is..." },
  { zh: "这周末想干嘛", en: "This weekend, I want to..." },
  { zh: "最近在看 / 在玩的东西", en: "Recently, I've been into..." },
  { zh: "一个最近的小目标", en: "A small goal I'm working on is..." },
  { zh: "随便吐槽两句", en: "I want to complain about..." },
  { zh: "此刻的心情", en: "Right now, I feel... because..." },
];
...
export const CHAT_TOPICS: TopicOption[] = [
  {
    ...
    directions: [
      { zh: "今天最顺利的一件事", en: "The best part of my day was..." },
      { zh: "今天有点糟心的瞬间", en: "Something annoying today was..." },
      { zh: "今天吃了什么", en: "Today I ate..." },
      { zh: "今天忙不忙", en: "Today was... because..." },
      { zh: "今天和谁聊了天", en: "Today I talked to... about..." },
      { zh: "今晚打算怎么放松", en: "Tonight, I plan to..." },
      { zh: "今天注意到的一件小事", en: "Today I noticed that..." },
      { zh: "用一个词形容今天", en: "One word for today is..." },
    ],
    promptSeed:
  ...
  },
  {
    ...
    directions: [
      { zh: "下一个最想去的地方", en: "The next place I want to visit is..." },
      { zh: "印象最深的一次旅行", en: "My most memorable trip was..." },
      { zh: "旅行踩过的坑", en: "One travel mistake I made was..." },
      { zh: "海边还是山里", en: "I prefer... because..." },
      { zh: "一个人还是结伴旅行", en: "I usually prefer traveling... because..." },
      { zh: "旅行必带的东西", en: "I always pack... when I travel." },
      { zh: "吃过最好吃的当地菜", en: "the best local food you tried" },
      { zh: "理想的周末短途", en: "My ideal weekend trip would be..." },
    ],
    promptSeed:
  ...
  },
  {
    ...
    directions: [
      { zh: "最近在忙的项目", en: "Recently, I've been working on..." },
      { zh: "今天开的会", en: "Today I had a meeting about..." },
      { zh: "想吐槽的工作瞬间", en: "I want to vent about..." },
      { zh: "工作里学到的新东西", en: "Something new I learned at work was..." },
      { zh: "和同事的相处", en: "Working with my teammates feels... because..." },
      { zh: "理想的工作节奏", en: "My ideal work-life balance is..." },
      { zh: "最近的小成就", en: "A small win at work recently was..." },
      { zh: "下份工作想做什么", en: "In my next job, I would want..." },
    ],
    promptSeed:
